...
import './ServiceSection.css'; // Make sure to create this CSS file

function ServiceSection() {
    return (

        <div className="Service-content">
        <h2>Area of Online Help & Services</h2>
        <ul className='list'>
                <li className='text'><a href="#support-faqs">Support FAQs</a></li>
                <li className='text'><a href="#customer-support-forums">Customer Support Forums</a></li>
                <li className='text'><a href="#instructional-videos">Instructional Videos</a></li>
                <li className='text'><a href="#informational-newsletters">Informational Newsletters</a></li>
                <li className='text'><a href="#webinars">Webinars (Live and Archived)</a></li>
                <li className='text'><a href="#request-forms">Request Forms</a></li>
                <li className='text'><a href="#online-courses">Online Courses</a></li>
                <li className='text'><a href="#social-updates">Social Updates</a></li>
            </ul>
      </div>
